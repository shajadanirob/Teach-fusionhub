...
<div className="relative h-[50vh] w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            {/* faq */}
            <div>
                <p className="text-center text-[#FF630E] font-semibold text-2xl my-5">POPULAR QUESTIONS</p>
                <h1 className="text-center text-4xl font-bold text-[#130F40]">Frequently Asked Questions</h1>
            </div>
                        ...
                        <div class="py-5">
                            <details class="group">
                                <summary class="flex cursor-pointer list-none items-center justify-between font-medium">
                                    <span> How Can I Purchase The Courses?
                                    </span>
                                ...
                                <p class="group-open:animate-fadeIn mt-3 text-neutral-600">Browse our course offerings on the website.Add the desired course to your cart.Proceed to checkout, provide payment details, and access your course.
                                </p>
                            </details>
                        </div>
                        <div class="py-5">
