...
Adam Smith
                ...
                <div data-aos='zoom-in-down' className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                    ...
                    <div className="mb-6 p-0">
                        <p className="block font-sans text-base font-light leading-relaxed text-inherit antialiased">
                        "I couldn't be happier with the website  created for my business. They took my vision and turned it into a user-friendly, visually stunning site. Their attention to detail and responsiveness were exceptional."
                        </p>
                    </div>
                </div>
                <div data-aos='zoom-in-down' className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
...
John Doe
                    ...
                    <div className="mb-6 p-0">
                        <p className="block font-sans text-base font-light leading-relaxed text-inherit antialiased">
                        "Working with has been a game-changer for my affiliate marketing business. Their strategies and insights have significantly increased my earnings. I can't thank them enough for their expertise and dedication."
                        </p>
                    </div>
                </div>
