...
const Instrector = () => {
    return (
        <div className="max-w-screen-xl mx-auto px-8 md:px-16 lg:px24 py-5 my-5">
             <p className="text-center text-[#FF630E] font-semibold text-2xl my-10">INSTRUCTORS</p>
            <h1 className="text-center text-[#130F40] text-4xl font-bold">Our Expert Instructors</h1>
    ...
    <div className="mt-8">
        ...
        <p className="mt-2 text-xl font-bold text-gray-600">Instructor
        </p>
